			...
			<div class="agileits-top">
				<form action="" method="post" enctype="multipart/form-data">
					<div class="styled-input w3ls-text">
						<input type="text" name="cust_id" value="<?php echo $fetch->cust_id;?>" required=""/>
						<label>Cust_id</label>
						<span></span>
					</div>
					<div class="styled-input w3ls-text">
					...
					<div class="styled-input w3ls-text">
						<input type="text" name="user_name" value="<?php echo $fetch->user_name;?>" required=""/>
						<label>User Name</label>
						<span></span>
					</div>
					<div class="styled-input w3ls-text">
						<input type="text" name="email_id" value="<?php echo $fetch->email_id;?>" required=""/>
						<label>Email ID</label>
						<span></span>
					</div>
					<div class="styled-input w3ls-text">
						<input type="text" name="contact_no" value="<?php echo $fetch->contact_no;?>" required=""/>
