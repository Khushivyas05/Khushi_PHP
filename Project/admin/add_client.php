 	...
 	<!---->
        ...
        <form name="clientform" action="" method="post" enctype="multipart/form-data" onsubmit="return validate()">
            ...
            <div class="col-md-6 form-group1">
              ...
              <input type="text" name="a_no" placeholder="Aadhar card no.">
            </div>
            <div class="col-md-6 form-group1 form-last">
              <label class="control-label">Driving license no.</label>
              <input type="text" name="dl_no" placeholder="Driving license no.">
            </div>
            <div class="clearfix"> </div>
            </div>
             <div class="col-md-12 form-group1 group-mail">
              <label class="control-label">PUC No</label>
              <input type="text" name="puc_no" placeholder="PUC no.">
            </div>
			<div class="col-md-12 form-group1 group-mail">
              <label class="control-label">Insurance No.</label>
              <input type="text" name="insurance" placeholder="Insurance no.">
            </div>
             <div class="clearfix"> </div>
             <div class="clearfix"> </div>
